...
if __name__ == '__main__':
    ...
    test = [5000.0, 24.0, 0.67, 60.0, 6000.0, 500.0, 20.0, 5.0, 200.0, 50.0, 0.0, 182.0, 18182.0, 1515.0, 0.5, 1, 'MX-01']
    a=handler.KNN_original(test)
    print('_original_'*20)
    print(a)
    b = handler.KNN_wd(test)
    print('_WD_wd_' * 20)
    print(b)
